...
import com.vignesh.library.constants.Constants;
...
public class Member extends Account{
    ...
    public void incrementTotalBooksCheckedOut(int numberOfBooks) {
    ...
    public boolean checkoutBookItem(BookItem bookItem) {
        ...
        Book bookReservation = BookReservation.fetchReservationDetails(bookItem.getBarcode());
